...
class CloudFailureHandlerTest {
    ...
    void rollbackOnExactDoesNotReachThreshold() throws Exception {
        ...
        verify(volumeResourceBuilder).delete(resourceBuilderContext, auth, volume1);
        verify(volumeResourceBuilder).delete(resourceBuilderContext, auth, volume2);
        verify(volumeResourceBuilder).delete(resourceBuilderContext, auth, volume4);
        verify(volumeResourceBuilder).delete(resourceBuilderContext, auth, volume5);
        verify(volumeResourceBuilder).delete(resourceBuilderContext, auth, volume6);

        verify(instanceResourceBuilder).delete(resourceBuilderContext, auth, instance1);
        verify(instanceResourceBuilder).delete(resourceBuilderContext, auth, instance5);
        verify(instanceResourceBuilder).delete(resourceBuilderContext, auth, instance6);
