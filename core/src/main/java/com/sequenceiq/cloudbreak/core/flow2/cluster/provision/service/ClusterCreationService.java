...
public class ClusterCreationService {
    ...
    public void handleClusterCreationFailure(StackView stackView, Exception exception, ProvisionType provisionType) {
        if (stackView.getClusterView() != null) {
            ...
            Status failureStatus = (provisionType == ProvisionType.REGULAR) ? RECOVERY_FAILED : CREATE_FAILED;
            DetailedStackStatus failureDetailedStatus = (provisionType == ProvisionType.REGULAR) ?
                    DetailedStackStatus.AVAILABLE : DetailedStackStatus.CLUSTER_RECOVERY_FAILED;
